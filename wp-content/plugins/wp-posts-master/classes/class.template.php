...
if ( ! class_exists( 'FlipperCode_HTML_Markup' ) ) {
	...
	class FlipperCode_HTML_Markup {
		...
		public function __construct( ) {
			...
			$this->allowed_attributes = array_fill_keys( array( 'choose_button', 'remove_button', 'lable', 'id', 'class', 'required', 'default_value', 'value', 'options', 'desc', 'before', 'after', 'radio-val-label', 'onclick', 'placeholder', 'textarea_rows', 'textarea_name', 'html', 'current', 'width', 'height', 'src', 'alt', 'heading', 'data', 'show' ) , '' );
		...
		public function get_manage_url() {
			return "<a style='float:right' target='_blank' href='http://codecanyon.net/item/wordpress-posts-listing-plugin/7292195'>Download Pro Version</a>";
		}
		/**
