...
?>
<div class="swpm-login-widget-form margin-top-20 padding-top-20 padding-left-20 padding-right-20 padding-bottom-20" style="border-radius: 10px;background-color: #efefef;">
    <form id="swpm-login-form" name="swpm-login-form" method="post" action="">
        <div class="text-center bg-lightgray">
            <img src="http://localhost:8888/legal/wp-content/uploads/2017/01/logo.png" width="40">
        ...
        <!--     <div class="swpm-remember-me">
            ...
            <div class="swpm-login-submit">
                <input type="submit" class="swpm-login-form-submit btn-block" name="swpm-login" value="<?php echo SwpmUtils::_('Login') ?>"/>
            </div>
