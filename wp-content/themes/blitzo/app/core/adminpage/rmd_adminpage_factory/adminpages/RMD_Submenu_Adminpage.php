...
class RMD_Submenu_Adminpage extends RMD_Adminpage 
{	
	...
	public function _create_sub_menu()
	{
		...
		add_submenu_page($parent_slug, $tag_title, $menu_title, $capability, $menu_slug,  array($this, '_create_form_admin_page'));
