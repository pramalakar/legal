 ...
 *	HOW TO USE:
	...
	$config = array(
		...
		'menu_slug'  		=> 'main-menu-slug',
		'menu_icon'  		=> 'dashicons-admin-tools',
		'menu_position' 	=> 110,
		'inputs' 			=> $inputs_config,
		'main_menu_slug'	=> 'rmd-theme-color-combo-setting'
	);
...
class RMD_Mainmenu_Adminpage extends RMD_Adminpage 
{	
	/**
	...
	public function _create_main_menu()
	{
		...
		add_menu_page($tag_title, $menu_title, $capability, $menu_slug, array($this, '_create_form_admin_page'), $menu_icon, $menu_position);

		$menu_title_alias = ( ! empty($menu_title_alias) ) ? $menu_title_alias : $menu_title;
		$parent_slug = $menu_slug;  

		//add_submenu_page ( string $parent_slug, string $page_title, string $menu_title, string $capability, string $menu_slug, callable $function = '' ); 
		add_submenu_page($parent_slug, $tag_title, $menu_title_alias, $capability, $menu_slug,  array($this, '_create_form_admin_page'));
