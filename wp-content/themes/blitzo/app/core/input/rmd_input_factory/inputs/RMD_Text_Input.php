...
/**
 *	RMD_Text_Input - this class will manage to create text input field.
 */
/***
 *	HOW TO USE:
...
class RMD_Text_Input extends RMD_Input 
{
	...
	{	 
		...
		<div class="input-column">
			<input style="padding:5px 8px; width:<?php echo $input['input_width']; ?>" type="text" id="<?php echo $input['input_name']; ?>" name="<?php echo $input['input_name']; ?>" value="<?php echo $input['input_value']; ?>" class="<?php echo $input['input_class']; ?>" >
