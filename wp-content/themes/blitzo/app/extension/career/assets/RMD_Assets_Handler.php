<?php
namespace rmd\extension\career\assets;
...
{ 
	...
	{    
		$this->path_to = get_stylesheet_directory_uri().'/app/extension/career/assets/'; 
	...
	{   
		wp_register_style( 'rmd-career-style-css', $this->path_to . 'css/career-style.css'); 
	}
	...
	{   
		/* Custom Script */
		wp_register_script( 'rmd-career-script-js', $this->path_to . 'js/career-script.js', array('rmd-jquery-min-js'), null, true );  
	}
	...
	{	  			
		...
		wp_enqueue_style('rmd-career-style-css');    

		/* Extended module scripts */
		wp_enqueue_script('rmd-career-script-js');   
