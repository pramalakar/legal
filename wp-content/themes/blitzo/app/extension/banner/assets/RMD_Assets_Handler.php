<?php
namespace rmd\extension\banner\assets;
...
{ 
	...
	{    
		$this->path_to = get_stylesheet_directory_uri().'/app/extension/banner/assets/'; 
	...
	{   
		wp_register_style( 'rmd-banner-style-css', $this->path_to . 'css/banner-style.css'); 
	}
	...
	{   
		/* Custom Script */
		wp_register_script( 'rmd-banner-script-js', $this->path_to . 'js/banner-script.js', array('rmd-jquery-min-js'), null, true );  
	}
	...
	{	  			
		...
		wp_enqueue_style('rmd-banner-style-css');    

		/* Extended module scripts */
		wp_enqueue_script('rmd-banner-script-js');   
