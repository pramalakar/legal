...
{      
	...
	{  
		...
		$config = array(
					'id' => 'rmd_cm_metabox_column_type_id', 
			    	'header_title' => 'Column Type',  
				    'inputs' => array( 
						array(
							'input_type'  => 'dropdown',
							'input_label' => '',
							'input_name'  => 'rmd_cm_metabox_column_type',
							'input_value' => '',
 	...
 	public function create_metabox_child_page_identifier($post_type)
	{   
 
		$config = array(
					'id' => 'rmd_cm_metabox_child_page_identifier_id', 
			    	'header_title' => 'Child Page Identinfier',  
				    'inputs' => array( 
						array(
							'input_type'  => 'dropdown',
							'input_label' => '',
							'input_name'  => 'rmd_cm_metabox_child_page_identifier',
							'input_value' => '',
							'input_option' => array(
								'child_page' => 'Child page as normal page',
								'child_section' => 'Child page as section', 
								),
							'input_class' => 'widefat',
							'input_description' => '', 
						), 
	...
	{ 
		...
		$config = array(
					'id' => 'rmd_cm_metabox_column_'.$idnum.'_container_style',
			    	'header_title' => 'Column Content '.$idnum.' - Container Style',  
				    'inputs' => array(   
						array(
							'input_type'  => 'mediauploader',
							'input_label' => 'Background Image',
							'input_name'  => 'rmd_cm_metabox_column_'.$idnum.'_background_image',
							'input_value' => '',
							'input_class' => 'widefat',
						...
						array(
							...
							'input_name'  => 'rmd_cm_metabox_column_'.$idnum.'_background_color',
							'input_value' => '',
							'input_class' => 'widefat',
							'input_description' => '',
							'input_display' => 'inline', 
						...
						array(
							...
							'input_name'  => 'rmd_cm_metabox_column_'.$idnum.'_background_color_opacity',
							'input_value' => '',
	...
	{ 
		...
		$config = array(
					'id' => 'rmd_cm_metabox_wrapper_style_id',
			    	'header_title' => 'Wrapper Style',  
				    'inputs' => array(  
				    	array(
							'input_type'  => 'dropdown',
							'input_label' => 'Background image and color position',
							'input_name'  => 'rmd_cm_metabox_wrapper_bgpos',
							'input_value' => '',
							'input_option' => array(
						...
						array(
							...
							'input_name'  => 'rmd_cm_metabox_wrapper_bgsize',
							'input_value' => '',
							'input_option' => array(
						...
						array(
							'input_type'  => 'color',
							'input_label' => 'Background color',
							'input_name'  => 'rmd_cm_metabox_wrapper_bgcolor',
							'input_value' => '',
							'input_class' => 'widefat',
							'input_description' => ''
						),
						array(
							'input_type'  => 'mediauploader',
							'input_label' => 'Background image',
							'input_name'  => 'rmd_cm_metabox_wrapper_bgimage',
							'input_value' => '',
							'input_class' => 'widefat',
							'input_description' => ''
						), 
						array(
							...
							'input_name'  => 'rmd_cm_metabox_wrapper_bgimage_alignment',
							'input_value' => '',
							'input_option' => array(
								'bgalign-left' => 'Left',
						...
						array(
							'input_type'  => 'dropdown',
							'input_label' => 'Background color transparency',
							'input_name'  => 'rmd_cm_metabox_wrapper_bgcolor_opacity',
							'input_value' => '',
							'input_option' => $bgcolor_opacity_options,
							'input_class' => 'widefat',
							'input_description' => 'Lighter (0.1) to Solid (0.9)'
						...
						array(
							...
							'input_name'  => 'rmd_cm_metabox_wrapper_bgpadding_top',
							'input_value' => '',
						...
						array(
							...
							'input_name'  => 'rmd_cm_metabox_wrapper_bgpadding_bottom',
							'input_value' => '',
							'input_option' => $bgpadding_options,
							'input_class' => 'widefat',
							'input_description' => ''
						...
						array(
							...
							'input_name'  => 'rmd_cm_metabox_wrapper_border_top_color',
							'input_value' => '',
							'input_class' => 'widefat',
							'input_description' => ''
						),
						array(
							...
							'input_name'  => 'rmd_cm_metabox_wrapper_border_bottom_color',
							'input_value' => '',
							'input_class' => 'widefat',
							'input_description' => ''
						),
						array(
							...
							'input_name'  => 'rmd_cm_metabox_wrapper_min_height',
							'input_value' => '', 
							'input_class' => 'widefat',
	...
	{  
		$config = array(
					'id' => 'rmd_cm_column_metabox_id'.$idnum.'',
			    	'header_title' => 'Column Content '.$idnum,  
				    'inputs' => array( 
						array(
							'input_type'  => 'wpeditor',
							'input_label' => '',
							'input_name'  => 'rmd_cm_column_metabox_'.$idnum.'_content',
							'input_value' => '',
							'input_class' => 'widefat',
							'input_description' => '',
							'input_display' => '', 
