<?php
namespace rmd\extension\courses\assets;
...
{ 
	...
	{    
		$this->path_to = get_stylesheet_directory_uri().'/app/extension/courses/assets/'; 
	...
	{   
		wp_register_style( 'rmd-courses-style-css', $this->path_to . 'css/courses-style.css'); 
	}
	...
	{   
		/* Custom Script */
		wp_register_script( 'rmd-courses-script-js', $this->path_to . 'js/courses-script.js', array('rmd-jquery-min-js'), null, true );  
	}
	...
	{	  			
		...
		wp_enqueue_style('rmd-courses-style-css');    

		/* Extended module scripts */
		wp_enqueue_script('rmd-courses-script-js');   
