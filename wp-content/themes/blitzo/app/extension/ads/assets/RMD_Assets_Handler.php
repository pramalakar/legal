<?php
namespace theme\rmd\extension\ads\assets;
...
{  
	...
	{    
		$this->path_to = get_stylesheet_directory_uri().'/app/extension/ads/assets/';  
	...
	{   
		wp_register_style( 'rmd-ads-style-css', $this->path_to . 'css/ads-style.css');  
	} 


	public function _wp_enqueue_scripts()
	{
		wp_enqueue_style('rmd-ads-style-css'); 
	}
