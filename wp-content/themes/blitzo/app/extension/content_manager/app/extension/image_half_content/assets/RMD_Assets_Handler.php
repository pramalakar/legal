<?php
namespace theme\rmd\extension\content_manager\app\extension\image_half_content\assets;
...
{ 
	...
	{    
		$this->path_to = get_stylesheet_directory_uri().'/app/extension/content_manager/app/extension/image_half_content/assets/'; 
	...
	{  
		...
		wp_register_style( 'rmd-image-half-content-style-css', $this->path_to . 'css/image-half-content-style.css'); 
	...
	{	  			
		...
		wp_enqueue_style('rmd-image-half-content-style-css');     
	}
