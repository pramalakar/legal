<?php
namespace theme\rmd\extension\content_manager\app\extension\wrap_text\app\facades;
...
{         
	...
	{ 
		$wppost_type = 'metabox'; 
		$config = array(
					'id' => 'rmd_cm_wrap_text_details',
			    	'header_title' => 'Content Details',  
				    'inputs' => array(    
						array(
							'input_type'  => 'mediauploader',
							'input_label' => 'Image',
							'input_name'  => 'rmd_cm_wrap_text_image',
							'input_value' => '',
							'input_class' => 'widefat',
							'input_description' => '',
						...
						array(
							'input_type'  => 'wpeditor',
							'input_label' => 'Content',
							'input_name'  => 'rmd_cm_wrap_text_content',
							'input_value' => '', 
							'input_class' => 'widefat', 
							'input_display' => 'inline', 
						),  
	...
	{ 
		$wppost_type = 'metabox'; 
		$config = array(
					'id' => 'rmd_cm_wrap_text_setting',
			    	'header_title' => 'Content Setting',  
				    'inputs' => array(    
						array(
							'input_type'  => 'dropdown',
							'input_label' => 'Image Alignment',
							'input_name'  => 'rmd_cm_wrap_text_image_alignment',
							'input_value' => '',
							'input_option' => array(
